...
namespace OOP_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a.AddFromConsole();
            ResearchTeam b = a._DeepCopy();
            a.NameOfOrganisation = "google";
            Console.WriteLine(a.ToString());
            Console.WriteLine(b.ToString());

            bool t = a.Save("dataResearchTeam.bat");
            Console.WriteLine("Save : "+t);
            a.NameOfOrganisation = "bbbbb";
            bool t2 = a.Load("dataResearchTeam.bat");
            Console.WriteLine("Load : "+t2);
            Console.WriteLine(a.ToString());
            ResearchTeam.Load("dataResearchTeam.bat", a);
            a.AddFromConsole();
            ResearchTeam.Save("dataResearchTeam.bat", a);
            Console.WriteLine(a.ToString());
